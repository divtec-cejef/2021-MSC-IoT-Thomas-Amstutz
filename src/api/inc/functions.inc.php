...
//   function addValue($humidity, $temperature, $date, $seqNumber, $loc_name) {
//     try{
//         // insertion des données dans la base de données
//         $dbh = conn_db(DB_NAME);

//         // modèle de requête
//         $sql = " INSERT INTO livre (liv_titre, liv_isbn, liv_nbPage, liv_editeur, id_format)
// 			  VALUES (:titre, :isbn, :nbPages, :editeur, :idFormat);";
...
//         $stmt->bindParam(':nbPages',$nbPage,PDO::PARAM_STR);
//         $stmt->bindParam(':editeur',$editeur,PDO::PARAM_STR);
//         $stmt->bindParam(':idFormat',$idFormat,PDO::PARAM_STR);
